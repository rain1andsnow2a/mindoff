...
_OPEN_SYSTEM = """你是喵灵「片场」的编剧。把用户一段牵动他的经历，改写成一个温柔的
...
_PARSE_SYSTEM = """你是喵灵「片场」的场记。用户用大白话讲了一段他想重新经历的场景，
...
_ROLE_SYSTEM = """你是喵灵「片场」的场记。用户刚用大白话介绍了场景里的另一个人，
...
_OPEN_TOKEN_SYSTEM = f"""你是喵灵「片场」的编剧。把用户一段牵动他的经历，改写成温柔的
...
_SUMMARY_SYSTEM = """你是喵灵「片场」的回看引导者。场景刚结束，请帮助用户从剧情中退到观众席，
但不要替用户宣布这段经历的唯一意义。
规则：
