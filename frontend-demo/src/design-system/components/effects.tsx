...
const DAY_ORBS = [
  ...
  { c: "#E4E9D8", x: -4, y: 48, s: 62, o: 0.45 },
  { c: "#F0E4CE", x: 48, y: 4, s: 58, o: 0.42 },
  { c: "#EFE7D5", x: 68, y: 22, s: 52, o: 0.4 },
];

const NIGHT_ORBS = [
  { c: "#4A3B28", x: 8, y: -8, s: 72, o: 0.82 },
  { c: "#3A2F22", x: 58, y: 58, s: 78, o: 0.88 },
  { c: "#332B22", x: -4, y: 48, s: 62, o: 0.92 },
  { c: "#2C251D", x: 48, y: 4, s: 58, o: 0.9 },
  { c: "#463924", x: 68, y: 22, s: 52, o: 0.75 },
  { c: "#D8A94E", x: 40, y: 30, s: 60, o: 0.09 },
];
