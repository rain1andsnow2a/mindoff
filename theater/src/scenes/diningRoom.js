...
import { createChair } from '../utils.js';
import { createFigure } from '../figure.js';

/** 家中餐桌：暖光吊灯下，两个人物相对而坐（人物形象为主） */
export function create() {
  ...
  [[-1.05, -0.55], [1.05, -0.55], [-1.05, 0.55], [1.05, 0.55]].forEach(([x, z]) => {
  ...
  function update(t) {
    ...
    steam.material.opacity = 0.12 + Math.sin(t * 0.8) * 0.05;
  }
